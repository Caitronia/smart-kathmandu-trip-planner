...
// ==========================================================
// === SAFE ASSET IMPORTS WITH FALLBACKS ====================
// ==========================================================
// Try to import images, but use fallbacks if they don't exist
let boudhaImage, chitwanImage, mustangImage, pokharaImage, sagarmathaImage;

try {
  boudhaImage = require('../assets/boudha.jpg');
} catch (e) {
  boudhaImage = 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?w=600&h=400&fit=crop';
  console.warn('boudha.jpg not found, using fallback image');
}

try {
  chitwanImage = require('../assets/chitwan.jpg');
} catch (e) {
  chitwanImage = 'https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?w=600&h=400&fit=crop';
  console.warn('chitwan.jpg not found, using fallback image');
}

try {
  mustangImage = require('../assets/mustang.jpg');
} catch (e) {
  mustangImage = 'https://images.unsplash.com/photo-1585409677983-0f6c41ca9c3b?w=600&h=400&fit=crop';
  console.warn('mustang.jpg not found, using fallback image');
}

try {
  pokharaImage = require('../assets/pokhara.jpg');
} catch (e) {
  pokharaImage = 'https://images.unsplash.com/photo-1571115764595-644a1f56a55c?w=600&h=400&fit=crop';
  console.warn('pokhara.jpg not found, using fallback image');
}

try {
  sagarmathaImage = require('../assets/sagarmatha.jpg');
} catch (e) {
  sagarmathaImage = 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1920&h=1080&fit=crop';
  console.warn('sagarmatha.jpg not found, using fallback image');
}
